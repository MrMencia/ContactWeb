...
namespace MyContactManagerData
{
    public class MyContactManagerDBContext : DbContext
    {
        ...
        {
            //Purposefully empty: Necesarry for Scaffold
        }

        public MyContactManagerDBContext(DbContextOptions<MyContactManagerDBContext> options)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<State>(x =>
            {
                x.HasData(
                    ...
                    new State() { Id = 9, Name = "District of Columbia", Abbreviation = "D.C" },
                    ...
                    new State() { Id = 46, Name = "Vermonth", Abbreviation = "VT" },
